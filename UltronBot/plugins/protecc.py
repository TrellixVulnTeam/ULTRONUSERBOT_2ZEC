...
from UltronBot.sql.waifu_sql import is_harem, add_grp, rm_grp, get_all_grp
from UltronBot.sql.husb_sql import is_husb, add_hus_grp, rm_hus_grp, get_all_hus_grp
from . import *
